...
namespace ScanTemplate.FormYJ
{
	public class LoadBitmapData{
		...
		private List<Imgsubject>  sublist;
		private Imgsubject activesj;
		private Dictionary<string,int> khindex = new Dictionary<string, int>();
		public LoadBitmapData(string bmpdatapath,int floorid,List<Imgsubject>  sublist){
	...
	//				fs.Flush();
		...
		public bool  SetActiveSubject(Imgsubject activesj){

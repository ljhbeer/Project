...
namespace EncyptTools
{
    ...
    {
        public static string GetSha256Hash(string machinecode)
        {
            byte[] bt = Encoding.GetEncoding("utf-8").GetBytes(machinecode);
        ...
        public static string GetSha1Hash(string machinecode)
        {
            byte[] bt = Encoding.GetEncoding("utf-8").GetBytes(machinecode);
    ...
    {
        public string GetMD5_32(string s, string _input_charset = "utf-8")
        {
